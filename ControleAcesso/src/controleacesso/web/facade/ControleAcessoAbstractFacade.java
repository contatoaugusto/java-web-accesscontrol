...
package controleacesso.web.facade;
...
import controleacesso.web.entity.util.EntityManagerFactory;
 ...
 */
public abstract class ControleAcessoAbstractFacade<T>  extends EntityManagerFactory{
    private Class<T> entityClass;

    public ControleAcessoAbstractFacade(Class<T> entityClass) {
